...
const baExperiences = [
  {
    ...
    description: [
      "Delivered 15 BA artefacts for Medicare Pro healthcare SaaS including requirements elicitation, process mapping, RTM, Agile planning, and UAT across 7 Epics.",
      "Conducted full BA lifecycle for a live client e-commerce platform — market research, competitor analysis, customer journey mapping, gap analysis, and Power BI reporting.",
      "Engaged stakeholders to gather and manage requirements, driving process improvements and ensuring alignment between business goals and technical delivery.",
    ],
    current: true,
  },
];
...
export const Experience = () => {
  const { role } = useRole();
  const experiences = role === "analyst" ? baExperiences : backendExperiences;
